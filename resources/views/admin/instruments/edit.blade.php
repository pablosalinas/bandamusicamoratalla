                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8">
                    ...
                    <div class="flex flex-col mt-4 border-t border-gray-800 pt-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input list="instrument_leave_reasons" name="leave_reason" id="leave_reason" value="{{ old('leave_reason', $instrument->leave_reason) }}" placeholder="Selecciona o escribe un motivo..." class="block w-full rounded-md border-0 bg-gray-800 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-amber-500 sm:text-sm sm:leading-6" style="color-scheme: dark;">
