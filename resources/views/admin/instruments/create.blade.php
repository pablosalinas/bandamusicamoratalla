<x-admin-layout>
    <x-slot name="header">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h2 class="text-3xl font-bold leading-tight tracking-tight text-white">Añadir Nuevo Instrumento</h2>
            </div>
    ...
    <div class="mt-8 max-w-xl">
        <form action="{{ route('admin.instruments.store') }}" method="POST" class="bg-gray-900 shadow-sm ring-1 ring-gray-800 sm:rounded-xl">
            @csrf
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Ej: Trompeta 1ª" required class="block w-full rounded-md border-0 bg-gray-800 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-amber-500 sm:text-sm sm:leading-6">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="type" id="type" value="{{ old('type') }}" placeholder="Ej: Viento Metal, Percusión, etc." class="block w-full rounded-md border-0 bg-gray-800 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-amber-500 sm:text-sm sm:leading-6">
                        </div>
                    ...
                    <div class="flex items-center mt-4 border-t border-gray-800 pt-6">
