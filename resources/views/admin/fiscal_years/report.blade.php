    ...
    <div class="max-w-5xl mx-auto bg-white p-10 shadow-lg rounded-lg border border-gray-200">
        ...
        <div class="grid grid-cols-3 gap-6 mb-12 avoid-break">
            <div class="bg-gray-50 rounded-lg p-5 border border-gray-200 shadow-sm text-center relative">
                ...
                <p class="text-xs text-gray-500 mt-2 border-t pt-1">Año anterior: {{ isset($previousYear) ? number_format($previousYear->total_income, 2, ',', '.') : '0,00' }} €</p>
            </div>
            <div class="bg-gray-50 rounded-lg p-5 border border-gray-200 shadow-sm text-center relative">
                ...
                <p class="text-xs text-gray-500 mt-2 border-t pt-1">Año anterior: {{ isset($previousYear) ? number_format($previousYear->total_expense, 2, ',', '.') : '0,00' }} €</p>
            </div>
            <div class="bg-gray-50 rounded-lg p-5 border border-gray-200 shadow-sm text-center {{ $fiscalYear->balance >= 0 ? 'ring-2 ring-green-500' : 'ring-2 ring-red-500' }} relative">
                ...
                <p class="text-xs text-gray-600 mt-2 border-t border-gray-300 pt-1 font-medium">Año anterior: {{ isset($previousYear) ? number_format($previousYear->balance, 2, ',', '.') : '0,00' }} €</p>
            </div>
        </div>
