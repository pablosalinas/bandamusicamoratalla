            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <textarea id="description" name="description" rows="6" class="block w-full rounded-md border-0 bg-gray-800 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-amber-500 sm:text-sm sm:leading-6">{{ old('description', $event->description) }}</textarea>
                        </div>
