...
Route::middleware(['auth', 'is_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('sheet-music/{sheetMusic}/view', [\App\Http\Controllers\Admin\SheetMusicController::class, 'view'])->name('sheet-music.view');
    ...
    Route::post('sheet-music/{sheetMusic}/delete-all-parts', [\App\Http\Controllers\Admin\SheetMusicController::class, 'deleteAllParts'])->name('sheet-music.delete-all-parts');
    ...
    Route::get('sheet-music-parts/{sheetMusicInstrument}/view', [\App\Http\Controllers\Admin\SheetMusicController::class, 'viewPart'])->name('sheet-music.view-part');
    ...
    Route::middleware(['admin_or_treasurer'])->group(function () {
        ...
        Route::post('settings/dashboard-cards', [\App\Http\Controllers\Admin\SettingsController::class, 'updateDashboardCards'])->name('settings.dashboard-cards.update');
